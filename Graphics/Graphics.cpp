...
void Graphics::RenderFrame()
{
	...
	//Draw Text
	spriteBatch->Begin();
	spriteFont->DrawString(spriteBatch.get(), L"Super Mario Brothers", DirectX::XMFLOAT2(0, 0), DirectX::Colors::White, 0.0f, DirectX::XMFLOAT2(0.0f, 0.0f), DirectX::XMFLOAT2(1.0f, 1.0f));
	spriteBatch->End();
...
bool Graphics::InitializeDirectX(HWND hwnd, int width, int height) {
	...
	//hr = this->device->CreateDepthStencilState(&depthstencildesc, this->depthStencilState.Get)
...
bool Graphics::InitializeScene()
{
	...
	// Load Textures
	hr = DirectX::CreateWICTextureFromFile(this->device.Get(), L"Data\\Textures\\mario.png", nullptr, myTexture.GetAddressOf());
	if (FAILED(hr)) {
